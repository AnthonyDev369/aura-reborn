...
import { X, ShoppingBag, Droplets } from "lucide-react";
            ...
            <div className="flex-1 p-8 md:p-12 flex flex-col overflow-y-auto">
                      ...
                      return (
                        ...
                        >
                          ...
                          <p className="text-muted text-[10px] uppercase tracking-widest mt-1">
                            {isAvailable ? `${variant.stock} en stock` : "Pre-orden"}
                          </p>
                        </button>
                      );
                    })}
                ...
                <div className="grid grid-cols-2 gap-4 text-sm pb-6 border-b border-glassBorder">
                  ...
                  {selectedVariant?.stock !== undefined && (
                    <div className="col-span-2">
                      ...
                      <p
                        className={`font-bold ${
                          selectedVariant.stock > 0 ? "text-green-600" : "text-blue-600"
                        }`}
                      >
                  ...
                  <div className="space-y-4">
                    ...
                    {selectedPerfume.top_notes && (
                      <div className="p-4 rounded-xl bg-bg border border-glassBorder">
                        <p className="text-muted text-[9px] uppercase tracking-widest mb-2">
                          Notas de Salida
                        </p>
              ...
              <p className="text-muted text-sm leading-relaxed mb-8 italic">
                ...
                {selectedPerfume.description ||
                  "Una sinfonía olfativa diseñada para trascender."}
                &quot;
              </p>

              {/* Mensaje de Pre-orden */}
              {isOutOfStock && canPreorder && (
                <div className="mb-6 p-4 rounded-xl bg-blue-50 border border-blue-200">
                  ...
                  <p className="text-blue-600 text-sm">
                    ...
                    Estimado de llegada:{" "}
                    <span className="font-bold">{estimatedDays} días hábiles</span>
                  </p>
                </div>
              )}
